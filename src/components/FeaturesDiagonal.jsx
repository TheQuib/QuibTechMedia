        ...
        <div className=" 2xl:w-[1150px] xl:w-[1050px]  md:w-4/5 flex justify-center bg-customDarkBg1 pt-12 lg:pt-24 pb-8 lg:pb-20 mx-auto lg:flex-row flex-col">
          <div className="w-3/4 lg:w-1/2 flex flex-col lg:mx-unset mx-auto">
            ...
            <h2 className="mt-10 mb-8 text-4xl lg:text-5xl custom-block-big-title">
              Here for Nonprofits and Small businesses
            </h2>
            <p className="mb-16 text-customGrayText leading-loose">
              QuibTech Media's pricing is built around content development and management for nonprofit organizations and small businesses.
            </p>
            <div
